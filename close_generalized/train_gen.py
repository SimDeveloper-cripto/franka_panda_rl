...
class AdaptiveCurriculumCallback(BaseCallback):
    def __init__(self, success_callback: SuccessRateCallback, check_freq=20000):
        super().__init__()
    ...
    def _on_step(self) -> bool:
        if self.n_calls % self.check_freq == 0:
            ...
            if sr > 0.80 and current_level < 1.0:
                ...
                print(f"\n[CURRICULUM] Level Up: {new_level:.2f} (Success Rate: {sr:.2f})")
        return True
...
def main():
    ...
    if args.play:
        ...
        ccb = AdaptiveCurriculumCallback(success_callback=scb, check_freq=25000)
